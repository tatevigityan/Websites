...
head.innerHTML+= " 17";
head.addEventListener("mouseover",function(){zagolovok.className="zag";});
head.addEventListener("mouseout",function(){zagolovok.className="zag";}); 
...
text=document.createTextNode("Бег-один из основных дисциплин в легкой атлетике.");
p.appendChild(text);
parent.insertBefore(p,form);

var inputData=document.getElementById("data");
inputData.addEventListener("input",function(){        
    var minData="1917-01-01";
...
newCheckBox.addEventListener("change",function(){
    if (newCheckBox.checked) {newTextArea.style.display="block";}
    else{newTextArea.style.display="none";}
});
